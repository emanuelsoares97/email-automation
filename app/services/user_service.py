...
class UserService:
    ...
    def criar_utilizador(cls, nome, email, password=None, role="user"):
        ...
        novo_utilizador = User(nome=nome, email=email, password=hashed_password, role=role)
    ...
    def listar_utilizadores(cls, ativos=True):
        ...
        try:
            if ativos:
                utilizadores = User.query.filter_by(ativo=True).all()
            else:
    ...
    def atualizar_utilizador(cls, utilizador_id, nome=None, email=None, password=None, role=None, ativo=None):
        ...
        try:
            utilizador = User.query.filter_by(id=utilizador_id).first()
